...
func easyjsonFcc75609DecodeModels(in *jlexer.Lexer, out *UserUpdate) {
...
func easyjsonFcc75609EncodeModels(out *jwriter.Writer, in UserUpdate) {
	out.RawByte('{')
	first := true
	_ = first
	if in.About != "" {
...
func (v UserUpdate) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFcc75609EncodeModels(&w, v)
...
func (v *UserUpdate) UnmarshalJSON(data []byte) error {
	...
	easyjsonFcc75609DecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *UserUpdate) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFcc75609DecodeModels(l, v)
}
