...
func easyjson727fe99aDecodeModels(in *jlexer.Lexer, out *Status) {
...
func easyjson727fe99aEncodeModels(out *jwriter.Writer, in Status) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Status) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson727fe99aEncodeModels(&w, v)
...
func (v *Status) UnmarshalJSON(data []byte) error {
	...
	easyjson727fe99aDecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Status) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson727fe99aDecodeModels(l, v)
}
